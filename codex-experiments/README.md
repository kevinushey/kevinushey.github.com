...
between decks. Explorer mode reduces incoming damage. The field guide contains
...
Tests cover 300 generated decks, collision and projectile boundaries, ammo,
shields, EMP, pause, death/retry, and all three campaign transitions. The
